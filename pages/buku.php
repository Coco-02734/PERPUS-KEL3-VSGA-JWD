...
<div id="content">
    ...
    <table id="tabel-tampil">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if ($pencarian != "") {
                $sql = "SELECT * FROM tbbuku WHERE judulbuku LIKE '%$pencarian%' OR pengarang LIKE '%$pencarian%' OR
						penerbit LIKE '%$pencarian%'";
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_buku.php?id=<?php echo $r_tampil_buku['idbuku']; ?>" class="tombol">Cetak Buku</a></div>
