...
<div id="content">
	...
	<p id="tombol-tambah-container"><a href="index.php?p=peminjaman-input" class="tombol">Tambah Data Peminjaman</a></p>
	<a target="_blank" href="pages/cetak-transaksipdf.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		?>
				<tr>
					...
					<td>
						<div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_kartu_peminjaman.php?id=<?php echo $r_tampil_peminjaman['idtransaksi']; ?>" class="tombol">Cetak Kartu</a></div>
						<div class="tombol-opsi-container"><a href="index.php?p=peminjaman-edit&id=<?php echo $r_tampil_peminjaman['idtransaksi']; ?>" class="tombol">Edit</a></div>
						<div class="tombol-opsi-container"><a href="proses/peminjaman-hapus.php?id=<?php echo $r_tampil_peminjaman['idtransaksi']; ?>" onclick="return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
					</td>
				</tr>
		<?php $nomor++;
			}
