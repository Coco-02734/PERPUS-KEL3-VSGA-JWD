...
<div id="content">
	...
	<table id="tabel-input">
		<tr>
			...
			<td class="isian-formulir"><input type="text" name="id_transaksi" value="<?php echo $r_tampil_peminjam['idtransaksi']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="isian-formulir"><input type="date" name="tgl_peminjaman" value="<?php echo $r_tampil_peminjam['tglpinjam']; ?>" class="isian-formulir isian-formulir-border" readonly></td>
		</tr>
		<tr>
			<td class="label-formulir">Tanggal Pengembalian</td>
			<td class="isian-formulir"><input type="date" name="tgl_pengembalian" value="<?php echo $r_tampil_peminjam['tglkembali']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
